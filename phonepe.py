...
st.logo(r'C:\Users\admin\OneDrive\Desktop\phonepe\Phonepe.png') #////////////////////Replace this with location of logo/////////////////
  ...
  if st.session_state['sql_connection_workflow'] and not st.session_state['sql_data_upload_workflow']:
    ...
    def sql_data_upload_process(new_folder_path,my_connection_properties):
      ...
      if database_name:
        ...
        file_path=r"C:\Users\admin\OneDrive\Desktop\phonepe\upload_list.xlsx" #///////////////////////////Replace with location of Excel File////////////////////////
        ...
        if page_option=='**Map Analysis**':
          ...
          with pan_area_1:
            ...
            def result_map(df):
              ...
              geo_data = gpd.read_file(r"C:\Users\admin\OneDrive\Desktop\phonepe\GeoJson.json") #///////////////Replace with json file location///////////
